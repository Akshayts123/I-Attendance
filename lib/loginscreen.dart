...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Color primary = const Color(0xFF314f8c);
          ...
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  customField("Enter your student id", Icons.person,
                      idController, false),
                  fieldTitle("Password"),
                  customField(
                      "Enter your Password", Icons.lock, passController, true),
                  GestureDetector(
                    onTap: () async {
  ...
  Widget customField(String hint, IconData icons,
